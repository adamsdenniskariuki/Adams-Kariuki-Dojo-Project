...
class TestDojoClass(unittest.TestCase):
	...
	def test_dojo_create_office_with_errors(self):
		...
		self.assertEqual(dojo_input_error, "Use alphabet a-z only for the room name and room type")
	...
	def test_dojo_add_fellow_with_errors(self):
		...
		self.assertEqual(dojo_input_error, "Use a-z only for the person name, type and wants accomodation")
